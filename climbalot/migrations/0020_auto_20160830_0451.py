# -*- coding: utf-8 -*-
# Generated by Django 1.10 on 2016-08-30 04:51
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('climbalot', '0019_auto_20160826_2004'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='quest',
            name='monkey',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='quests', to='climbalot.Monkey'),
        ),
        migrations.AlterField(
            model_name='quest',
            name='v_value',
